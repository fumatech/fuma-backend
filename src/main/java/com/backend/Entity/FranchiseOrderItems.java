...
@Entity
public class FranchiseOrderItems {
	...
	@ManyToOne
	@JoinColumn(name = "franchise_purchase_order_id")
	@JsonBackReference
	private FranchisePurchaseOrder franchisePurchaseOrder;
	...
	public FranchisePurchaseOrder getFranchisePurchaseOrder() {
		return franchisePurchaseOrder;
	}

	public void setFranchisePurchaseOrder(FranchisePurchaseOrder franchisePurchaseOrder) {
		this.franchisePurchaseOrder = franchisePurchaseOrder;
	}
