...
public class WarrantyClaim {
    ...
    private List<WarrantyClaimItems> warrantyClaimItems;
	...
	public List<WarrantyClaimItems> getWarrantyClaimItems() {
		return warrantyClaimItems;
	}

	public void setWarrantyClaimItems(List<WarrantyClaimItems> warrantyClaimItems) {
		this.warrantyClaimItems = warrantyClaimItems;
	}
